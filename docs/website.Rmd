...
If you are using RStudio, the easist way to get started is to use the Radix Website option in the RStudio **New Project** dialog:
...
If you are not using RStudio you can also call the Radix `create_website()` function:
